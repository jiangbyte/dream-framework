package io.jiangbyte.app.modules.auths.reset.entity;
...
@Data
@TableName(value = "auths_password_reset", autoResultMap = true)
@Schema(name = "AuthsPasswordReset", description = "密码重置表")
public class AuthsPasswordReset extends BaseEntity {
    @Serial
